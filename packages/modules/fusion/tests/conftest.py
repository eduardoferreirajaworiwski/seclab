...
@pytest.fixture()
def db_session():
    import seclab_cve_watch.db  # noqa: F401  (register cve_watch tables)
    import seclab_monitor.models  # noqa: F401  (register monitor tables)
    import seclab_threatlens.db  # noqa: F401  (register threatlens tables)
